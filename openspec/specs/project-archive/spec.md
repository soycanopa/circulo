...
Allow users to archive (hide) projects from the sidebar and provide an interactive server indicator with server switching and mDNS discovery in the sidebar footer.
