...
Ensure chat sessions created in the Chat view persist across app restarts and provide convenient access to chat creation from the sidebar toolbar and thread list.
