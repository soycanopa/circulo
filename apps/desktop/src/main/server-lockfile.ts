/**
 * Lockfile for the Circulo-managed OpenCode server process.
 *
 * Written when Circulo spawns a server, removed on clean shutdown. On next
 ...
 *
 * Path: ~/.local/share/circulo/server.lock
 */
