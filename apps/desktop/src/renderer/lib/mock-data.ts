...
const IDS = {
	// Projects
	projectCirculo: "proj-a1b2c3d4e5f6",
...
const DIRS = {
	circulo: "/Users/demo/Projects/circulo",
...
const mockDiscoveredProjects: DiscoveryState["projects"] = [
	{
		id: IDS.projectCirculo,
		worktree: DIRS.circulo,
		vcs: "git",
		name: "circulo",
...
function assistantMsg(
	...
	return {
		...
		mode: "Adaptive",
		agent: "code",
		path: { cwd: DIRS.circulo, root: DIRS.circulo },
...
/** Project slug for the default session (circulo project) */
export const MOCK_DEFAULT_PROJECT_SLUG = `circulo-${IDS.projectCirculo.slice(0, 12)}`
