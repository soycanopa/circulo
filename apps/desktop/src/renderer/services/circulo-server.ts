/**
 * Type-safe RPC client for the Circulo local backend server (Bun + Hono).
 *
...
import { createClient } from "@circulo/server/client"
 ...
 * Calls `GET /api/servers/opencode` on the Circulo backend.
 */
...
/**
 * Checks if the Circulo server is running.
 */
